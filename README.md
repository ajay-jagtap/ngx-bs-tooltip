...
![angular tooltip](https://raw.githubusercontent.com/ajay-jagtap/ngx-bs-tooltip/master/resources/tooltip-example.png)

## Installation

1. Install npm module:

    `npm install ngx-bs-tooltip --save`
...
2. If you are using system.js you may want to add this into `map` and `package` config:
    ...
    {
        "map": {
            "ngx-bs-tooltip": "node_modules/ngx-bs-tooltip"
        },
        "packages": {
            "ngx-bs-tooltip": { "main": "index.js", "defaultExtension": "js" }
        }
    }
    ```
